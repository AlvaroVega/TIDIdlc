...
import es.tid.TIDIdlc.xml2cpp.XmlExpr2Cpp;
import es.tid.TIDIdlc.xml2cpp.XmlType2Cpp;

import java.math.BigInteger;
import java.util.Vector;

public class UnionCpp extends Union
{
    //	boolean minus = false;
    public UnionCpp(Scope father_scope, Element union_element)
    {
            ...
            for (int i = 0; i < expr_list.size(); i++) {
                ...
                try {
                    if (discrim_kind.equals(OMG_short)) {
                        ...
                        // { 
                        //	String val =
                        // String.valueOf(XmlExpr2Cpp.getIntExpr(expr_list.item(i)));
                        String val = String.valueOf(XmlExpr2Cpp
        ...
        throws SemanticException
    {
        ...
        for (int i = 0; i < union_cases.size(); i++) {
            ...
            for (int j = 0; j < case_labels.size(); j++) {
                ...
                String value = null;
                try {
                    Object expr = XmlExpr2Cpp.getExpr(el.getParentNode(),
                                                      getDiscKind());
                    value = expr.toString();
                }
    ...
    public String getDiscKind()
    {
        if (m_disc_kind == null) {
            ...
            if (scopelist.getLength() > 0) {
                ...
                m_disc_kind = XmlType2Cpp.basicMapping(kind);
                ...
                m_disc_kind = XmlType2Cpp.getType((Element) switch_el
                    .getFirstChild());
            }
        }
        return m_disc_kind;

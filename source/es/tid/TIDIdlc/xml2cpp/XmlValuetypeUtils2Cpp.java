 ...
 */
class XmlValuetypeUtils2Cpp extends XmlInterfaceUtils2Cpp
    implements Idl2XmlNames
{
    ...
    protected void generateCppMethodHeader(StringBuffer buffer, Element doc)
    {
        ...
        if (returnTypeL.getLength() > 0) {
            ...
            buffer.append(XmlType2Cpp.getType(ret));
            buffer.append(" ");
        } else {
            buffer.append("void ");
        }
        ...
        for (int i = 1; i < nodes.getLength(); i++) {
            ...
            if (el.getTagName().equals(OMG_parameter)) {
                ...
                if (i > 1)
                    buffer.append(", ");
                buffer.append(XmlType2Cpp.getParamType(paramType, 
    ...
    protected void generateCppFactoryHeader(StringBuffer buffer, Element doc,
                                            String returnType)
    {
        ...
        for (int i = 0; i < nodes.getLength(); i++) {
            ...
            if (el.getTagName().equals(OMG_init_param_decl)) {
                ...
                if (i > 0)
                    buffer.append(", ");
                buffer.append(XmlType2Cpp.getParamType(paramType, "in"));
                buffer.append(" ");
                buffer.append(paramName);
            }
        }
    ...
    protected void generateHelperCppFactory(StringBuffer buffer, Element doc,
                                            String returnType)
    {
